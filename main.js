...
//   document.getElementById("acc-title-1").innerHTML =
//     "WELCOME SPEECH AND OVERVIEW";
//   document.getElementById("acc-title-2").innerHTML =
//     "<strong>Andrew Yang</strong> - CEO, Microsoft";
//   document.getElementById("acc-title-3").innerHTML =
//     "THE IMPACT OF AI ON WORLD";
//   document.getElementById("acc-title-4").innerHTML =
//     "<strong>Tim Cook</strong> - CEO, Apple";
//   document.getElementById("acc-title-5").innerHTML = "CATERED LUNCH BUFFET";
//   document.getElementById("acc-title-6").innerHTML =
//     "<strong>Sponsored</strong> - AirTM, PayPal, TechGeek";
//   document.getElementById("acc-title-7").innerHTML = "NEXT-GEN DESIGN";
//   document.getElementById("acc-title-8").innerHTML =
//     "<strong>Mary Doe</strong> - Lead Designer, Google";
// });
...
//   document.getElementById("btn-4").classList.remove("active_schedule_btn");
//   document.getElementById("acc-title-1").innerHTML =
//     "SEMINAR ON DEEPLEARNING & TENSORFLOW";
//   document.getElementById("acc-title-2").innerHTML =
//     "<strong>Gennady Korotkevich</strong> - #1 IN GOOGLE CODE JAM";
//   document.getElementById("acc-title-3").innerHTML =
//     "DATA MINING & DRILLING NUMPY";
//   document.getElementById("acc-title-4").innerHTML =
//     "<strong>William Lin</strong> - Freshman, MIT";
//   document.getElementById("acc-title-5").innerHTML = "CATERED LUNCH BUFFET";
//   document.getElementById("acc-title-6").innerHTML =
//     "<strong>Sponsored</strong> - AirTM, PayPal, TechGeek";
//   document.getElementById("acc-title-7").innerHTML =
//     "WORKSHOP ON ADOBE PHOTOSHOP";
//   document.getElementById("acc-title-8").innerHTML =
//     "<strong>Sarah Ricky</strong> - Lead Designer, Microsoft";
// });
